...
if selected_model == "Freight Cost Prediction":
    ...
    **Objective:**
    ...
    # FIXED: Logic must be indented inside this main IF block
    if submit_freight:
        input_data = {
            "Dollars": [dollars] 
        }
        ...
        val = prediction_df['Predicted_Freight'].iloc[0]

        st.metric(label="📊 Estimated Freight Cost", value=f"${val:,.2f}")
...
# ---------------------------------------------------------
    ...
    **Objective:**
    ...
    # FIXED: This logic should be outside the 'with st.form' but inside the 'else'
    if submit_flag:
        input_data_flag = {
        ...
        flag_prediction = predict_invoice_flag(input_data_flag)['Predicted_Flag']
